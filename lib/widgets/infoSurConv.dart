...
class _InfoSurConvState extends State<InfoSurConv> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<UserBlockE>.value(
      initialData: UserBlockE(isBlockE: "isBlockE"),
                ...
                return StreamBuilder(
                    ...
                    builder: (context, snapshotNbreSesMsgImg){
                      if(!snapshotNbreSesMsgImg.hasData){
                        ...
                        int nbreMesMsgImg = snapshotNbreMesMsgImg.data!.docs.length;
                        int mesMsg = snapshotMesMessages.data!.docs.length;
                        int nbreSesMsgImg = snapshotNbreSesMsgImg.data!.docs.length;
