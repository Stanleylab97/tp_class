...
import 'package:tp_class/widgets/infoSurConv.dart';
...
class _MessagesState extends State<Messages> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance.collection('utilisateurs')
        .doc(widget.idExp).collection('bloque')
        .doc('${widget.idExp}${widget.idDest}')
        ...
        child: StreamBuilder<DonnEesUtil>(
            ...
            builder: (context, snapshot) {
                ...
                Future<void> envoiImage(ImageSource source) async {
                  //XFile? imageSelectionEe = await ImagePicker.pickImage(source: source);
                  setState(() {
                   // this.image = imageSelectionEe.path;
